...
# تم تحديث الاستيراد هنا لاستخدام render_navbar
from ui.layout import render_navbar, render_footer
...
# 4. سيناريو 2: المستخدم مسجل دخول -> عرض لوحة التحكم
    ...
    # استدعاء الشريط العلوي بدلاً من القائمة الجانبية
    render_navbar()
    ...
    st.info("👈 استخدم شريط التنقل العلوي للتنقل بين صفحات النظام.")
